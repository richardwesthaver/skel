...
:DEBUG @ 87823.03 :: running test:  #<TEST VM :fn VM-test32511 :args NIL :persist NIL {10042BBCF3}> 
:DEBUG @ 87823.05 :: #<PASS (LET ((VM (MAKE-SK-VM 201)))
                              (DOTIMES (I 200) (SKS-POP VM))
                              T)> 
:DEBUG @ 87823.05 :: #<PASS (SKS-POP VM)> 
#<PASS VM-TEST32511> 
:DEBUG @ 87823.05 :: running test:  #<TEST MAKEFILE :fn MAKEFILE-test32510 :args NIL :persist NIL {10042BA1F3}> 
:DEBUG @ 87823.05 :: #<PASS (FILE-EXISTS-P %TMP)> 
#<PASS MAKEFILE-TEST32510> 
:DEBUG @ 87823.05 :: running test:  #<TEST SKELFILE :fn SKELFILE-test32509 :args NIL :persist NIL {10042B8A03}> 
:DEBUG @ 87823.055 :: #<PASS (INIT-SKELFILE %TMP)> 
:DEBUG @ 87823.055 :: #<PASS (FILE-EXISTS-P %TMP)> 
:DEBUG @ 87823.055 :: #<PASS (SK-MAKE-FILE
                              (MAKE-INSTANCE 'SK-PROJECT NAME nada) PATH %TMP)> 
:DEBUG @ 87823.055 :: #<PASS (FILE-EXISTS-P %TMP)> 
#<PASS SKELFILE-TEST32509> 
:DEBUG @ 87823.055 :: running test:  #<TEST HEADER-COMMENTS :fn HEADER-COMMENTS-test32508 :args NIL :persist NIL {10040E71A3}> 
:DEBUG @ 87823.06 :: #<PASS (EQ
                             (TYPE-OF
...
:DEBUG @ 87823.06 :: #<PASS (EQ
                             ...
                             'FILE-HEADER)> 
#<PASS HEADER-COMMENTS-TEST32508> 
:DEBUG @ 87823.06 :: running test:  #<TEST SANITY :fn SANITY-test32507 :args NIL :persist NIL {10040E56A3}> 
:DEBUG @ 87823.07 :: #<PASS (EQ T (APPLY #'/= (SKELS 1000)))> 
#<PASS SANITY-TEST32507> 
No tests failed.
#+end_src
