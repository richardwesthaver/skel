...
:DEBUG @ 2154.1 :: running test:  #<TEST VM :fn VM-test34841 :args NIL :persist NIL {1006EAE8B3}> 
:DEBUG @ 2154.1133 :: #<PASS (LET ((VM (MAKE-SK-VM 201)))
                               (DOTIMES (I 200) (SKS-POP VM))
                               T)> 
:DEBUG @ 2154.1133 :: #<PASS (SKS-POP VM)> 
#<PASS VM-TEST34841> 
:DEBUG @ 2154.1133 :: running test:  #<TEST MAKEFILE :fn MAKEFILE-test34840 :args NIL :persist NIL {1006EACD53}> 
:DEBUG @ 2154.1233 :: #<PASS (NULL (SK-WRITE-FILE MK IF-EXISTS OVERWRITE))> 
#<PASS MAKEFILE-TEST34840> 
:DEBUG @ 2154.1233 :: running test:  #<TEST SKELFILE :fn SKELFILE-test34839 :args NIL :persist NIL {1006EAAF93}> 

#<SXP:SXP {1002C19AD3}> 
#<SXP:SXP {1002C19C13}> :DEBUG @ 2154.14 :: #<PASS (SK-WRITE-FILE
                                                    (MAKE-INSTANCE 'SK-PROJECT
                                                                   NAME nada
                                                                   PATH %TMP)
                                                    IF-EXISTS OVERWRITE)> 
:DEBUG @ 2154.14 :: #<PASS (INIT-SKELFILE %TMP)> 

#<SXP:SXP {10037BE333}> :DEBUG @ 2154.14 :: #<PASS (PRINT
                                                    (SK-READ-FILE
                                                     (MAKE-INSTANCE
                                                      'SK-PROJECT)
                                                     PATH %TMP))> 
#<PASS SKELFILE-TEST34839> 
:DEBUG @ 2154.14 :: running test:  #<TEST HEADER-COMMENTS :fn HEADER-COMMENTS-test34838 :args NIL :persist NIL {1006EA8F63}> 
:DEBUG @ 2154.1433 :: #<PASS (EQ
                              (TYPE-OF
...
:DEBUG @ 2154.1433 :: #<PASS (EQ
                              (TYPE-OF
                               (MAKE-SOURCE-FILE-HEADER
                                (MAKE-SOURCE-HEADER-COMMENT foo-test TIMESTAMP
                                                            T DESCRIPTION
                                                            nothing to see here
                                                            OPTS
                                                            '(Definitely-Not_Emacs: T;))))
                              'FILE-HEADER)> 
#<PASS HEADER-COMMENTS-TEST34838> 
:DEBUG @ 2154.1433 :: running test:  #<TEST SANITY :fn SANITY-test34837 :args NIL :persist NIL {1006D87233}> 
:DEBUG @ 2154.1467 :: #<PASS (EQ T (APPLY #'/= (SKELS 1000)))> 
#<PASS SANITY-TEST34837> 
No tests failed.
#+end_src
