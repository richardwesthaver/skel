...
:DEBUG @ 73614.39 :: running test:  #<TEST VM :fn VM-test46557 :args NIL :persist NIL {10040E6643}> 
:DEBUG @ 73614.41 :: #<PASS (LET ((VM (MAKE-SK-VM 201)))
                              (DOTIMES (I 200) (SKS-POP VM))
                              T)> 
:DEBUG @ 73614.41 :: #<PASS (SKS-POP VM)> 
#<PASS VM-TEST46557> 
:DEBUG @ 73614.41 :: running test:  #<TEST MAKEFILE :fn MAKEFILE-test46556 :args NIL :persist NIL {10040E4B43}> 
:DEBUG @ 73614.44 :: #<PASS (NULL (SK-WRITE-FILE MK IF-EXISTS OVERWRITE))> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-RULE RULE MK)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-RULE RULE MK)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-RULE RULE MK T)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-RULE RULE MK T)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-DIRECTIVE CMD MK)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-DIRECTIVE CMD MK)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-VAR '(A B) MK)> 
:DEBUG @ 73614.44 :: #<PASS (PUSH-VAR '(B C) MK)> 
:DEBUG @ 73614.44 :: #<PASS (NULL (SK-WRITE-FILE MK IF-EXISTS OVERWRITE))> 
#<PASS MAKEFILE-TEST46556> 
:DEBUG @ 73614.44 :: running test:  #<TEST SKELFILE :fn SKELFILE-test46555 :args NIL :persist NIL {10040E1293}> 
:DEBUG @ 73614.445 :: #<PASS (SK-WRITE-FILE
                              (MAKE-INSTANCE 'SK-PROJECT NAME nada PATH %TMP)
                              IF-EXISTS OVERWRITE)> 
:DEBUG @ 73614.445 :: #<PASS (INIT-SKELFILE %TMP)> 
:DEBUG @ 73614.445 :: #<PASS (BUILD-AST
                              (SK-READ-FILE (MAKE-INSTANCE 'SK-PROJECT) PATH
                                            %TMP))> 
#<PASS SKELFILE-TEST46555> 
:DEBUG @ 73614.445 :: running test:  #<TEST HEADER-COMMENTS :fn HEADER-COMMENTS-test46554 :args NIL :persist NIL {10040472D3}> 
:DEBUG @ 73614.45 :: #<PASS (EQ
                             (TYPE-OF
...
:DEBUG @ 73614.45 :: #<PASS (EQ
                             ...
                             'FILE-HEADER)> 
#<PASS HEADER-COMMENTS-TEST46554> 
:DEBUG @ 73614.45 :: running test:  #<TEST SANITY :fn SANITY-test46553 :args NIL :persist NIL {10040457D3}> 
:DEBUG @ 73614.45 :: #<PASS (EQ T (APPLY #'/= (SKELS 1000)))> 
#<PASS SANITY-TEST46553> 
No tests failed.
#+end_src
